...
def main():
    ...
    train_df, val_df = train_test_split(dataframe_for_generator, test_size=config['trainparams'].getfloat(
        'test_fraction'), random_state=42)  # before it was 42
...
>>>>>>> 9fa90f3fc1feb8ccd9cb85c2282c0f45df7547f5
    ...
    model.compile(loss='binary_crossentropy',
                  optimizer=tf.keras.optimizers.Adam(
                      learning_rate=myf.lr_schedule(0)),
                  metrics=metrics)
    model.summary()
    model.get_config()
